/**
 * Centralized schema definitions for all Prometheus SQLite tables.
...
// ============================================================================
// Group Chat (services/prometheus/group-chat/index.ts)
// ============================================================================
...
export function initAllPrometheusTables(retryCount = 0): void {
  ...
  try {
    ...
    console.error('Error initializing Prometheus SQLite tables:', e)
    ...
    try {
      ...
      initAllPrometheusTables(retryCount + 1)

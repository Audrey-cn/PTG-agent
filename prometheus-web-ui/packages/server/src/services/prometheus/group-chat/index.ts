...
import { GC_ROOMS_TABLE, GC_MESSAGES_TABLE, GC_ROOM_AGENTS_TABLE, GC_CONTEXT_SNAPSHOTS_TABLE, GC_ROOM_MEMBERS_TABLE, GC_PENDING_SESSION_DELETES_TABLE, GC_SESSION_PROFILES_TABLE } from '../../../db/prometheus/schemas'
...
class ChatStorage {
    ...
    init(): void {
        ...
        const db = this.db()
        if (!db) return
        // Tables are now created centrally in initAllPrometheusTables()

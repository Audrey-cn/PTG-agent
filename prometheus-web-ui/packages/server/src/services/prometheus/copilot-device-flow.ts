 ...
 *
 * Mirrors the upstream prometheus-agent implementation
 * (`prometheus_cli/copilot_auth.py:155-275`):
 ...
 *
 * Client ID `Ov23li8tweQw6odWQebz` is reused from upstream prometheus-agent for now;

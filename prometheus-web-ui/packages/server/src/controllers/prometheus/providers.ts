...
import { getActiveAuthPath } from '../../services/prometheus/prometheus-profile'
...
export async function create(ctx: any) {
  ...
  try {
    ...
    try { await prometheusCli.restartGateway() } catch (e: any) { logger.error(e, 'Gateway restart failed') }

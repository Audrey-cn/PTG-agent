...
import { startDeviceFlow, pollDeviceFlow } from '../../services/prometheus/copilot-device-flow'
...
} from '../../services/prometheus/copilot-models'
import { getActiveEnvPath } from '../../services/prometheus/prometheus-profile'
...
async function persistToken(token: string): Promise<void> {
  // 与 disable 对称：只动 ~/.prometheus/.env，apps.json 是 VS Code 的文件不要碰。
 ...
 *   - source='env'        → also clear ~/.prometheus/.env COPILOT_GITHUB_TOKEN
 *                           (this token belongs to the prometheus ecosystem).

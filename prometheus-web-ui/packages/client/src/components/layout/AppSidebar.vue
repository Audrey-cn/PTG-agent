...
<template>
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed }">
    <div class="sidebar-logo" @click="router.push('/prometheus/chat')">
      <img :src="logoPath" alt="Prometheus" class="logo-img" />
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('conversation')">
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.chat' }" @click="handleNav('prometheus.chat')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
            </svg>
            <span>{{ t("sidebar.chat") }}</span>
          </button>
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.history' }" @click="handleNav('prometheus.history')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.groupChat' }" @click="handleNav('prometheus.groupChat')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('agent')">
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.jobs' }" @click="handleNav('prometheus.jobs')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.channels' }" @click="handleNav('prometheus.channels')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
            </svg>
            <span>{{ t("sidebar.channels") }}</span>
          </button>
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.skills' }" @click="handleNav('prometheus.skills')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.memory' }" @click="handleNav('prometheus.memory')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M9 18h6" />
              <path d="M10 22h4" />
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.models' }" @click="handleNav('prometheus.models')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('monitoring')">
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.logs' }" @click="handleNav('prometheus.logs')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.usage' }" @click="handleNav('prometheus.usage')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('tools')">
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.terminal' }" @click="handleNav('prometheus.terminal')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.files' }" @click="handleNav('prometheus.files')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('system')">
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.gateways' }" @click="handleNav('prometheus.gateways')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.profiles' }" @click="handleNav('prometheus.profiles')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'prometheus.settings' }" @click="handleNav('prometheus.settings')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <circle cx="12" cy="12" r="3" />
    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <a class="github-link" href="https://github.com/EKKOLearnAI/prometheus-web-ui" target="_blank" rel="noopener noreferrer" title="GitHub">
        ...
        <span class="version-text" @click="openChangelog">Prometheus Web UI v{{ appStore.serverVersion || "0.1.0" }}</span>
        <ThemeSwitch />
      </div>

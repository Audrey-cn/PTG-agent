...
import MarkdownRenderer from '@/components/prometheus/chat/MarkdownRenderer.vue'
import { fetchSkillContent, fetchSkillFiles, pinSkillApi, type SkillFileEntry } from '@/api/prometheus/skills'
...
async function viewFile(filePath: string) {
  ...
  try {
    ...
    if (filePath.startsWith('/')) {
      ...
      const segments = filePath.split('/.prometheus/skills/')[1]
      if (segments) {

...
import { saveCredentials as saveCredsApi, fetchWeixinQrCode, pollWeixinQrStatus, saveWeixinCredentials } from '@/api/prometheus/config'
...
// Save credentials to .env (matching prometheus gateway setup behavior)

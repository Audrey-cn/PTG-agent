...
import type { Message } from "@/stores/prometheus/chat";
import { computed, onBeforeUnmount, onMounted, ref, watchEffect } from "vue";
import { useI18n } from "vue-i18n";
import { useMessage } from "naive-ui";
import { downloadFile } from "@/api/prometheus/download";
 ...
 * Upload format in content: [File: name.txt](/tmp/prometheus-uploads/abc123.txt)
 */

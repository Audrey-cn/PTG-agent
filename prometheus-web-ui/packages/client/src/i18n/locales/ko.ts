export default {
  ...
  sidebar: {
    ...
    connected: '연결됨',
    disconnected: '연결 끊김',
    updateTip: '터미널에서 "prometheus-web-ui update"를 실행하여 업데이트하세요',
  ...
  chat: {
    contextRemaining: '남음',
    emptyState: 'Prometheus Agent와 대화를 시작하세요',
    ...
    openHistory: '기록 열기',
    prometheusHistory: 'Prometheus 기록',
    historyScopeHint: '소스별로 그룹화된 Prometheus 기록 세션을 읽기 전용으로 봅니다.',
    noSessions: '세션 없음',
    newChat: '새 채팅',
  ...
  models: {
    ...
    copilotAddDetected: '이 컴퓨터에서 GitHub Copilot OAuth 토큰이 감지되었습니다. 추가를 클릭하여 Prometheus에서 Copilot을 활성화하세요.',
    copilotAddSourceEnv: '출처: ~/.prometheus/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: '출처: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: '출처: VS Code Copilot 확장 (apps.json)',
    copilotDeleteHintEnv: '이 작업은 ~/.prometheus/.env의 COPILOT_GITHUB_TOKEN을 지웁니다. 다른 도구에는 영향이 없습니다.',
    copilotDeleteHintGhCli: 'Copilot이 Prometheus에서 숨겨집니다. gh CLI 로그인에는 영향이 없으며 `gh auth status`는 여전히 로그인 상태를 표시합니다.',
    copilotDeleteHintAppsJson: 'Copilot이 Prometheus에서 숨겨집니다. VS Code Copilot 확장 로그인에는 영향이 없습니다.',
    customBadge: '커스텀',
    previewBadge: '프리뷰',
    disabledBadge: '사용 불가',
  ...
  platform: {
    ...
    weixinTokenHint: 'weixin CLI QR 로그인에서 가져오기 (prometheus weixin)',
  ...
  changelog: {
    ...
    new_0_5_5_2: 'Prometheus 세션 기록 페이지 추가',

export default {
  ...
  sidebar: {
    ...
    updateTip: 'Fuhren Sie "prometheus-web-ui update" im Terminal aus, um zu aktualisieren',
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit Prometheus Agent',
    ...
    prometheusHistory: 'Prometheus-Verlauf',
    historyScopeHint: 'Schreibgeschützte Prometheus-Verlaufssitzungen, nach Quelle gruppiert.',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in Prometheus zu aktivieren.',
    copilotAddSourceEnv: 'Quelle: ~/.prometheus/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Quelle: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Quelle: VS Code Copilot-Erweiterung (apps.json)',
    copilotDeleteHintEnv: 'Dies löscht COPILOT_GITHUB_TOKEN in ~/.prometheus/.env. Andere Tools sind nicht betroffen.',
    copilotDeleteHintGhCli: 'Copilot wird aus Prometheus ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus Prometheus ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (prometheus weixin)',
    accountId: 'Konto-ID',
  ...
  changelog: {
    ...
    new_0_5_5_2: 'Verlaufsseite für Prometheus-Sitzungshistorie hinzugefügt',

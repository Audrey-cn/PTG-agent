export default {
  ...
  sidebar: {
    ...
    updateTip: 'Executez "prometheus-web-ui update" dans le terminal pour mettre a jour',
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec Prometheus Agent',
    ...
    prometheusHistory: 'Historique Prometheus',
    historyScopeHint: 'Sessions d’historique Prometheus en lecture seule, regroupées par source.',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans Prometheus.',
    copilotAddSourceEnv: 'Source : ~/.prometheus/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Source : gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Source : extension Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Cela supprimera COPILOT_GITHUB_TOKEN dans ~/.prometheus/.env. Les autres outils ne sont pas affectés.',
    copilotDeleteHintGhCli: 'Copilot sera masqué dans Prometheus. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans Prometheus. Votre extension Copilot de VS Code reste connectée.',
  ...
  platform: {
    ...
    weixinTokenHint: 'Depuis la connexion QR de la CLI weixin (prometheus weixin)',
  ...
  changelog: {
    ...
    new_0_5_5_2: 'Ajout d\'une page d\'historique pour les sessions Prometheus',
    ...
    new_0_5_4_4: 'Fix web terminal Prometheus CLI availability after Docker deployment',
    ...
    new_0_5_4_7: 'Align usage analytics with Prometheus state DB schema',
    ...
    new_0_5_1_1: 'Auto-sync Prometheus history sessions on first startup',
    new_0_5_1_2: 'Fix session sync failure with old Prometheus versions (backward compatible)',
    ...
    new_0_4_8_7: 'Fix login token validation using Prometheus session endpoint',
    ...
    new_0_4_8_10: 'Move upload directory from temp to ~/.prometheus-web-ui/upload',

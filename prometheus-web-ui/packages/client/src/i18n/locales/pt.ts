export default {
  ...
  sidebar: {
    ...
    updateTip: 'Execute "prometheus-web-ui update" no terminal para atualizar',
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o Prometheus Agent',
    ...
    prometheusHistory: 'Histórico Prometheus',
    historyScopeHint: 'Sessões do histórico Prometheus somente leitura, agrupadas por origem.',
...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no Prometheus.',
    copilotAddSourceEnv: 'Origem: ~/.prometheus/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origem: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origem: extensão Copilot do VS Code (apps.json)',
    copilotDeleteHintEnv: 'Isto irá limpar o COPILOT_GITHUB_TOKEN em ~/.prometheus/.env. Outras ferramentas não são afetadas.',
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no Prometheus. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no Prometheus. A extensão Copilot do VS Code continuará conectada.',
  ...
  platform: {
    ...
    weixinTokenHint: 'Do login QR da CLI weixin (prometheus weixin)',
  ...
  changelog: {
    ...
    new_0_5_5_2: 'Adicionada página de histórico para sessões Prometheus',

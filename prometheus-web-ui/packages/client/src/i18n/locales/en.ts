export default {
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "prometheus-web-ui update" in terminal to update',
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with Prometheus Agent',
    ...
    prometheusHistory: 'Prometheus History',
    historyScopeHint: 'Read-only Prometheus history sessions grouped by source.',
  ...
  models: {
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in Prometheus.',
    ...
    copilotDeleteHintEnv: 'This will clear COPILOT_GITHUB_TOKEN in ~/.prometheus/.env. Other tools are not affected.',
    copilotDeleteHintGhCli: 'Copilot will be hidden from Prometheus. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from Prometheus. Your VS Code Copilot extension login is not affected.',
    customBadge: 'CUSTOM',
  ...
  platform: {
    ...
    weixinTokenHint: 'From weixin CLI QR login (prometheus weixin)',
  ...
  changelog: {
    ...
    new_0_5_5_2: 'Add History page for browsing Prometheus session history',
    ...
    new_0_5_4_3: 'Fix web terminal Prometheus CLI availability after Docker deployment',
    ...
    new_0_5_4_6: 'Align usage analytics with Prometheus state DB schema',

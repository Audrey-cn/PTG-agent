export default {
  ...
  sidebar: {
    ...
    collapse: '收起菜单',
    expand: '展开菜单',
    updateTip: '在终端运行 "prometheus-web-ui update" 即可更新',
  ...
  chat: {
    contextRemaining: '剩余',
    emptyState: '开始与 Prometheus Agent 对话',
    ...
    openHistory: '打开历史',
    prometheusHistory: 'Prometheus 历史',
    historyScopeHint: '这里按来源只读查看 Prometheus 历史会话。',
    noSessions: '暂无会话',
    searchTitle: '搜索会话',
  ...
  models: {
    ...
    copilotAddDetected: '已在本机检测到 GitHub Copilot OAuth 凭证，点击「添加」即可在 Prometheus 中启用 Copilot。',
    copilotAddSourceEnv: '来源：~/.prometheus/.env（COPILOT_GITHUB_TOKEN）',
    copilotAddSourceGhCli: '来源：gh CLI（gh auth token）',
    copilotAddSourceAppsJson: '来源：VS Code Copilot 插件（apps.json）',
    copilotDeleteHintEnv: '此操作会清除 ~/.prometheus/.env 中的 COPILOT_GITHUB_TOKEN，不影响其他工具。',
    copilotDeleteHintGhCli: 'Copilot 将从 Prometheus 列表移除。不会影响 gh CLI —— `gh auth status` 仍显示已登录。',
    copilotDeleteHintAppsJson: 'Copilot 将从 Prometheus 列表移除。不会影响 VS Code Copilot 插件的登录。',
    customBadge: '自定义',
    previewBadge: '预览',
    disabledBadge: '不可用',
  ...
  platform: {
    ...
    weixinTokenHint: '通过 weixin CLI 扫码登录获取 (prometheus weixin)',
  ...
  changelog: {
    ...
    new_0_5_5_2: '新增历史页面，用于浏览 Prometheus 会话历史记录',
    ...
    new_0_5_4_3: '修复 Docker 部署后 Web 终端无法使用 Prometheus CLI 的问题',
    new_0_5_4_4: '添加工作区对话框标题 i18n 翻译，改进会话持久化',
    new_0_5_4_5: '支持代码块复制反馈，显示用户通知',
    new_0_5_4_6: '对齐使用分析与 Prometheus 状态数据库架构',
    ...
    new_0_5_1_1: '首次启动时自动同步 Prometheus 历史会话',
    new_0_5_1_2: '修复旧版本 Prometheus 会话同步失败问题（向后兼容）',
    ...
    new_0_4_8_10: '上传目录从临时目录迁移到 ~/.prometheus-web-ui/upload',

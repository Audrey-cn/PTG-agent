...
import SkillList from '@/components/prometheus/skills/SkillList.vue'
import SkillDetail from '@/components/prometheus/skills/SkillDetail.vue'
import { fetchSkills, type SkillCategory, type SkillSource, type SkillInfo } from '@/api/prometheus/skills'

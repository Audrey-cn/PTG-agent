...
import { ref } from 'vue'
import * as profilesApi from '@/api/prometheus/profiles'
import type { PrometheusProfile, PrometheusProfileDetail } from '@/api/prometheus/profiles'

const ACTIVE_PROFILE_STORAGE_KEY = 'prometheus_active_profile_name'

export const useProfilesStore = defineStore('profiles', () => {
  const profiles = ref<PrometheusProfile[]>([])
  ...
  const activeProfile = ref<PrometheusProfile | null>(null)
  const detailMap = ref<Record<string, PrometheusProfileDetail>>({})

...
class AutoDiscovery:
    ...
    def find_connections(
        self, source_ids: list[str] = None, min_strength: float = 0.3
    ) -> list[Connection]:
        """
        发现跨领域弱连接
    ...
    def crystalize_insight(self, connections: list[Connection], title: str = None) -> Insight:
        """
        从连接生成洞察
        ...
        content_parts.append(
            "基于以上关联，建议进一步探索这些素材之间的潜在联系，可能发现新的知识洞察。\n"
        )
    ...
    def discover(self, min_age_days: int = 14, min_strength: float = 0.3) -> Insight:
        """

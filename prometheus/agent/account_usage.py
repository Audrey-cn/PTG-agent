...
from prometheus.agent.anthropic_adapter import _is_oauth_token, resolve_anthropic_token
from prometheus.cli.auth import _read_codex_tokens, resolve_codex_runtime_credentials
...
def render_account_usage_lines(
    snapshot: AccountUsageSnapshot | None, *, markdown: bool = False
) -> List[str]:
    if not snapshot:
        return []

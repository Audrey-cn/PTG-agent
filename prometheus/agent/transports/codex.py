...
from prometheus.agent.transports.base import ProviderTransport
from prometheus.agent.transports.types import NormalizedResponse, ToolCall
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: list[dict[str, Any]], **kwargs) -> Any:
        ...
        from prometheus.agent.codex_responses_adapter import _chat_messages_to_responses_input

        return _chat_messages_to_responses_input(messages)

    def convert_tools(self, tools: list[dict[str, Any]]) -> Any:
        """Convert OpenAI tool schemas to Responses API function definitions."""
        from prometheus.agent.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        """
        from prometheus.agent.codex_responses_adapter import (
            _chat_messages_to_responses_input,
            _responses_tools,
        )
        from prometheus.agent_loop import DEFAULT_AGENT_IDENTITY
    ...
    def preflight_kwargs(self, api_kwargs: Any, *, allow_stream: bool = False) -> dict:
        ...
        """
        from prometheus.agent.codex_responses_adapter import _preflight_codex_api_kwargs
...
from prometheus.agent.transports import register_transport  # noqa: E402

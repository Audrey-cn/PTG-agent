"""AWS Bedrock Converse API adapter for Prometheus Agent."""
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Prometheus with Bedrock support: pip install -e '.[bedrock]'"
        )
...
CONTEXT_OVERFLOW_PATTERNS = [
    ...
    re.compile(
        r"ModelStreamErrorException.*(?:Input is too long|too many input tokens)", re.IGNORECASE
    ),
]

...
provides the same ``get_prometheus_home()`` and ``display_hermes_home()``
...
try:
    from prometheus.constants_core import display_hermes_home as display_hermes_home
    ...
    def display_hermes_home() -> str:
        ...
        Mirrors ``prometheus.constants_core.display_hermes_home()``."""

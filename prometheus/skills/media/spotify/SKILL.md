...
Control the user's Spotify account via the Prometheus Spotify toolset (7 tools). Setup guide: https://prometheus.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `prometheus auth spotify` again.

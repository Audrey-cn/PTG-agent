...
```python
import sys
sys.path.insert(0, "/home/teknium/.prometheus/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.prometheus/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Prometheus installs package this)

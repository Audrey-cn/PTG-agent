...
Built for [Prometheus Agent](https://github.com/NousResearch/prometheus). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/prometheus/skills/creative/ascii-video`](https://github.com/NousResearch/prometheus/tree/main/skills/creative/ascii-video) via PR.

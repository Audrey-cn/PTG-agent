...
class CronManager:
    ...
    def __init__(self):
        ...
        self.jobs_file = get_paths().home / "cron_jobs.json"
    ...
    def add_job(
        ...
        try:
            # 构建触发器
            if trigger == "interval":
                trigger_obj = IntervalTrigger(minutes=minutes or 0, hours=hours or 0)
            ...
            self.scheduler.add_job(job_func, trigger_obj, id=job_id, replace_existing=True)
...
def get_cron_manager() -> CronManager | None:
    """获取 Cron 管理器"""

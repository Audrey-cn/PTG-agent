...
THREAT_PATTERNS = [
    ...
    (
        r"\$HOME/\.prometheus/\.env|\~/\.prometheus/\.env",
        "prometheus_env_access",
        "critical",
        "exfiltration",
        "directly references Prometheus secrets file",
    ),
    (
    ...
    (
        r"\.prometheus/config\.yaml|\.prometheus/SOUL\.md",
        "prometheus_config_mod",
        "critical",
        "persistence",
        "references Prometheus configuration files directly",
    ),
    (

...
class CloudBrowserProvider(ABC):
    ...
    ``prometheus setup`` / ``prometheus tools``; the choice is persisted as
    ...
    def get_error_message(self) -> str | None:
        """Return a human-readable error message if not configured.

        Override this to provide helpful setup instructions when

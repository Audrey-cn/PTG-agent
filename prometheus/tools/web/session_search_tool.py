...
def session_search(
    ...
    try:
        ...
        async def _summarize_all() -> list[str | Exception]:
            ...
            async def _bounded_summary(text: str, meta: dict[str, Any]) -> str | None:
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from prometheus._state import DEFAULT_DB_PATH
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "- I want to check if you've solved a similar problem before\n"

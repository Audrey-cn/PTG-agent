...
The Prometheus docs site hosts a JSON manifest of curated models for providers
...
1. ``get_catalog()`` — returns a parsed manifest dict.
   ...
   - Reads disk cache at ``~/.prometheus/cache/model_catalog.json``.
...
DEFAULT_CATALOG_URL = (
    "https://prometheus-agent.nousresearch.com/docs/api/model-catalog.json"
)

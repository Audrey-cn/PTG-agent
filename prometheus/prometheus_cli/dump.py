...
Outputs a compact, plain-text summary of the user's Prometheus setup
...
from prometheus.prometheus_cli.config import get_prometheus_home, get_env_path, get_project_root, load_config
...
def _redact(value: str) -> str:
    ...
    ``prometheus dump`` formats empty values as blank, not as ``"(not set)"``).
    """
...
def _gateway_status() -> str:
    ...
    try:
        from prometheus.prometheus_cli.gateway import get_gateway_runtime_snapshot

...
Usage:
    prometheus pairing list              # Show all pending + approved users
    prometheus pairing approve <platform> <code>  # Approve a pairing code
    prometheus pairing revoke <platform> <user_id> # Revoke user access
    prometheus pairing clear-pending     # Clear all expired/pending codes
"""

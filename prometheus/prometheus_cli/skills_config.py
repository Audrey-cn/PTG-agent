...
`prometheus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.prometheus/config.yaml under:
...
from prometheus.prometheus_cli.config import cfg_get, load_config, save_config
from prometheus.prometheus_cli.colors import Colors, color
from prometheus.prometheus_cli.platforms import PLATFORMS as _PLATFORMS

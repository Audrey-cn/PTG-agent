...
from prometheus.prometheus_cli import kanban_db as kb
...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    p_list.add_argument("--mine", action="store_true",
                        help="Filter by $PROMETHEUS_PROFILE as assignee")
    ...
    p_comment.add_argument("--author", default=None,
                           help="Author name (default: $PROMETHEUS_PROFILE or 'user')")
...
def _profile_author() -> str:
    ...
    for env in ("PROMETHEUS_PROFILE_NAME", "PROMETHEUS_PROFILE"):
        ...
        if v:
            return v
    try:
        from prometheus.prometheus_cli.profiles import get_active_profile_name

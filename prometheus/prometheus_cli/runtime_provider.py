...
from prometheus.prometheus_cli import auth as auth_mod
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        from prometheus.prometheus_cli.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            try:
                from prometheus.prometheus_cli.models import azure_foundry_model_api_mode
        ...
        if provider in ("opencode-zen", "opencode-go"):
            ...
            # Refs #16878.
            from prometheus.prometheus_cli.models import opencode_model_api_mode
    ...
    *,
    ...
    if provider == "anthropic":
        ...
        if _is_azure_endpoint:
            ...
            # chain.  Accept both `key_env` (Prometheus canonical — matches the
            # custom_providers field name) and `api_key_env` (documented in the
            # Azure Foundry guide and read by most Prometheus-compatible importers).

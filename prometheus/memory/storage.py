...
class HybridStorage:
    ...
    def _load_from_sqlite(self, memory_id: str) -> MemoryRecord | None:
        with self._conn() as conn:
            row = conn.execute(
    ...
    def _load_from_md(self, memory_id: str) -> MemoryRecord | None:
        for layer in self.LAYERS:
    ...
    def _parse_md(self, filepath: str) -> MemoryRecord | None:

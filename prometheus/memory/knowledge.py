...
class CompiledKnowledgeManager:
    ...
    def __init__(self, data_dir: str = None):
        ...
        self.source_dir = os.path.join(
            self.storage.data_dir, "knowledge", "source"
        )
        self.compiled_dir = os.path.join(
            self.storage.data_dir, "knowledge", "compiled"
        )
        self.metadata_dir = os.path.join(
            self.storage.data_dir, "knowledge", "metadata"
        )
    ...
    def add_source(self, content: str, title: str = None,
                   tags: List[str] = None, source_type: str = "raw") -> str:
        """添加原始素材"""
    ...
    def add_citation(self, entry_id: str, source_id: str,
                     sentence_idx: int = None, quote: str = None) -> bool:
        """添加引用"""
    ...
    def list_knowledge(self, entry_type: str = None,
                       maturity: str = None) -> List[dict]:
        """列出所有知识"""
        knowledge = []
    ...
    def _parse_md(self, filepath: str) -> Optional[dict]:
    ...
    def _find_entry(self, entry_id: str) -> Optional[str]:

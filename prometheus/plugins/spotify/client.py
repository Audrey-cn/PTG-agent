"""Thin Spotify Web API helper used by Prometheus native tools."""
...
class SpotifyClient:
    ...
    def get_album_tracks(
        self, *, album_id: str, limit: int = 20, offset: int = 0, market: str | None = None
    ) -> Any:
        return self.request(
            "GET",
    ...
    def get_saved_tracks(
        ...
        return self.request(
            "GET", "/me/tracks", params={"limit": limit, "offset": offset, "market": market}
        )
    ...
    def get_saved_albums(
        ...
        return self.request(
            "GET", "/me/albums", params={"limit": limit, "offset": offset, "market": market}
        )
...
def _friendly_spotify_error_message(
    *,
    ...
    if status_code == 401:
        return "Spotify authentication failed or expired. Run `prometheus auth spotify` again."
    ...
    if status_code == 403:
        ...
        if "scope" in normalized_detail or "permission" in normalized_detail:
            return "Spotify rejected the request because the current auth scope is insufficient. Re-run `prometheus auth spotify` to refresh permissions."

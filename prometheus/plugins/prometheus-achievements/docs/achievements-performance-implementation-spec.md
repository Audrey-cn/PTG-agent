# Prometheus Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.prometheus/plugins/prometheus-achievements/state.json` (existing unlock state)
  - `~/.prometheus/plugins/prometheus-achievements/scan_snapshot.json` (new)
  - `~/.prometheus/plugins/prometheus-achievements/scan_checkpoint.json` (new)

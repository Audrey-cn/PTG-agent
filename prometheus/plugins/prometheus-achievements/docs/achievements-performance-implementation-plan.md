# Prometheus Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.prometheus/plugins/prometheus-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.prometheus/plugins/prometheus-achievements/scan_checkpoint.json`.

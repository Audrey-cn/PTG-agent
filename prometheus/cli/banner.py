...
def _skin_color(key: str, fallback: str) -> str:
    ...
    try:
        from prometheus.cli.skin_engine import get_active_skin
...
def build_welcome_banner(
    ...
    try:
        from prometheus.tools.mcp_tool import get_mcp_status
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from prometheus.cli.config import get_managed_update_command, recommended_update_command

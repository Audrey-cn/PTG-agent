...
class DingTalkAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(self) -> list[re.Pattern]:
        ...
        for pattern in patterns:
            ...
            try:
                ...
                logger.warning(
                    "[%s] Invalid DingTalk mention pattern %r: %s", self.name, pattern, exc
                )
        if compiled:
    ...
    def _extract_media(self, message: "ChatbotMessage"):
        ...
        if msg_type_str == "picture" and not media_urls:
            ...
            msg_type = (
                MessageType.PHOTO if any("image" in t for t in media_types) else MessageType.TEXT
            )
    ...
    async def _create_and_stream_card(
        ...
        *,
        ...
        try:
            ...
            out_track_id = f"prometheus_{uuid.uuid4().hex[:12]}"

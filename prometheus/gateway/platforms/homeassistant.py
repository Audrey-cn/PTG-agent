...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._rest_session = aiohttp.ClientSession(timeout=aiohttp.ClientTimeout(total=30))
    ...
    def _format_state_change(
        ...
        if domain == "sensor":
            ...
            return (
                f"[Home Assistant] {friendly_name}: changed from {old_val}{unit} to {new_val}{unit}"
            )

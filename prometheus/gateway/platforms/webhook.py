...
class WebhookAdapter(BasePlatformAdapter):
    ...
    def _reload_dynamic_routes(self) -> None:
        ...
        subs_path = prometheus_home / _DYNAMIC_ROUTES_FILENAME
        ...
        try:
            ...
            self._dynamic_routes = {k: v for k, v in data.items() if k not in self._static_routes}
    ...
    async def _handle_webhook(self, request: "web.Request") -> "web.Response":
        ...
        if skills:
            try:
                from prometheus.agent.skill_commands import (
        ...
        self._seen_deliveries = {
            k: v for k, v in self._seen_deliveries.items() if now - v < self._idempotency_ttl
        }
    ...
    async def _deliver_github_comment(self, content: str, delivery: dict) -> SendResult:
        ...
        try:
            ...
            logger.error(
                "[webhook] 'gh' CLI not found — install GitHub CLI for github_comment delivery"
            )

...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_prometheus_home()`` helper (PROMETHEUS_HOME-aware and
...
RULES_FILE = get_prometheus_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_prometheus_home() / "feishu_comment_pairing.json"

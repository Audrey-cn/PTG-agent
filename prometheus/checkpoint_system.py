...
class CheckpointSystem:
    ...
    def _get_critical_files(self):
        ...
        from prometheus.memory_system import get_memory_path, get_soul_path, get_user_profile_path

        return [get_config_path(), get_user_profile_path(), get_memory_path(), get_soul_path()]
